...
const faqs: FAQ[] = [
  { question: "How much does a website cost?", answer: "Our website packages start at $3,500 (Starter, delivered in 48 hours), $6,500 (Professional, 5 days), and $10,000+ (Premium, custom timeline). All packages include a .com domain for 1 year and SSL certificate. Maintenance is $199/month." },
  { question: "What is your payment policy?", answer: "We require 50% upfront before work begins, 25% at design approval, and 25% on delivery. All payments are processed securely through secure payment processing via Stripe." },
  ...
  { question: "What payment methods do you accept?", answer: "We accept Stripe, bank transfer, Visa, and debit cards. This ensures buyer protection and secure payment processing for both parties. USD is our primary currency, with GBP and EUR pricing available on request." },
  { question: "Can you manage my social media and email marketing?", answer: "Absolutely! Social Media Management is $999/month (4 posts/week, 2 platforms, monthly report). Email Marketing is $599/month (4 newsletters, automation, analytics). Or get both plus a strategy call for $1,499/month with Full Marketing." },
  { question: "Do you offer maintenance after the site is live?", answer: "Yes! Our maintenance plan is $199/month and includes security updates, weekly backups, uptime monitoring, and 1 hour of support. We also offer 30 days of free bug-fix support after launch." },
];
