...
const AnalyticsReporting = () => {
  return (
    <SEOProvider title="Analytics & Reporting | SyncSphere" description="Professional analytics and reporting from $149/month. Track your business performance with clear, actionable insights.">
      <ServiceLayout>
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-16">
            <Card>
              <CardHeader><CardTitle>Basic Report</CardTitle><div className="text-3xl font-bold">$149<span className="text-lg font-normal">/mo</span></div></CardHeader>
              <CardContent>
                ...
                <a href="https://wa.me/447424819094?text=Hi! I'd like the Basic Analytics Report ($149/mo)." target="_blank" rel="noopener noreferrer" className="mt-4 block">
                  <Button className="w-full" variant="outline">Get Started</Button>
                </a>
              </CardContent>
            </Card>
            <Card className="border-primary">
              <CardHeader><Badge className="w-fit mb-2">Recommended</Badge><CardTitle>Full Dashboard</CardTitle><div className="text-3xl font-bold">$299<span className="text-lg font-normal">/mo</span></div></CardHeader>
              <CardContent>
                <ul className="space-y-2">
                ...
                <a href="https://wa.me/447424819094?text=Hi! I'd like the Full Dashboard Analytics package ($299/mo)." target="_blank" rel="noopener noreferrer" className="mt-4 block">
