...
const EmailMarketing = () => {
  return (
    <SEOProvider title="Email Marketing Services | SyncSphere" description="Professional email marketing from $599/month. Newsletter campaigns, automated sequences, and subscriber management.">
      <ServiceLayout>
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <Card>
              <CardHeader><CardTitle>Setup Only</CardTitle><div className="text-3xl font-bold">$399</div><p className="text-sm text-muted-foreground">One-time setup</p></CardHeader>
              <CardContent>
            ...
            <Card className="border-primary">
              <CardHeader><Badge className="w-fit mb-2">Most Popular</Badge><CardTitle>Starter</CardTitle><div className="text-3xl font-bold">$599<span className="text-lg font-normal">/mo</span></div></CardHeader>
              <CardContent>
                <ul className="space-y-2">
            ...
            <Card>
              <CardHeader><CardTitle>Growth</CardTitle><div className="text-3xl font-bold">$999<span className="text-lg font-normal">/mo</span></div></CardHeader>
              <CardContent>
                <ul className="space-y-2">
