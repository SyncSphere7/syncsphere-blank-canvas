  ...
  <SEOProvider title="Website Design UK | Custom Sites from £399 | SyncSphere" description="Professional website design for UK businesses from £399. Delivered in 48 hours. Domain and SSL included." region="uk" service="web-development">
    <ServiceLayout>
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center"><Card className="bg-primary/5 border-primary/20"><CardContent className="p-8"><p className="text-foreground/70 flex items-center justify-center gap-2"><CreditCard className="h-4 w-4"/>50% upfront, 50% on delivery • Stripe, bank transfer, Visa & debit accepted • Hosting: £79/month</p></CardContent></Card></div>
      </div>
    </ServiceLayout>
  </SEOProvider>
);
